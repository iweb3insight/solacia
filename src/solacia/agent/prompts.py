...
EMOTION_GUIDES = {
    "happy": [
        "The user is in a good mood — share their excitement, "
        "ask what made them happy, keep the energy up.",
    ...
    "anxious": [
        "The user might be anxious — don't rush to give advice, "
        "ask about the specific situation first.",
        "They seem tense — listen first, let them get it all out before responding.",
        "When anxious, what people need most is someone to listen "
    ...
    "sad": [
        ...
        "Start with empathy, then gently understand what happened. "
        "Don't rush to comfort or change the subject.",
    ],
    "angry": [
    ...
    "confused": [
        ...
        "Being lost is scary enough without being lectured — "
        "listen to their thoughts first, sort it out together.",
        "No need to have all the answers — "
        "helping them sort out the situation is already valuable.",
    ],
}
